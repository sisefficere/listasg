...
export default async function Home() {
  return (
    <header className="flex flex-col w-full items-center h-full lg:pt-3">
      <div className="flex flex-col w-full gap-2 items-end h-full lg:rounded-xl estrutura-padding bg-vermelho-1-escuro max-md:pt-[45px] md:pt-5 pb-5 lg:shadow-[0_0_10px_rgba(255,153,153,1)]">
